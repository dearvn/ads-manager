...
if (!function_exists('ads_manager_skip_rest_admin_notice')) {
    /**
     ...
     */
    function ads_manager_skip_rest_admin_notice() {
        if (current_user_can('install_plugins')) {
            $data = get_plugin_data(ADS_MANAGER_FILE, true, false);
            global $wp_version;
...
add_action('admin_notices', 'ads_manager_skip_rest_admin_notice');
