<?php
namespace Dearvn\Ads_manager;
use Dearvn\Ads_manager\base\Core as BaseCore;
use Dearvn\Ads_manager\rest\HelloWorld;
use Dearvn\Ads_manager\view\menu\Page;
use Dearvn\Ads_manager\view\widget\Widget;
 ...
 * See API docs.
 *
 * @api {get} /ads_manager/v1/plugin Get plugin information
