...
if (!function_exists('ads_manager_skip_php_admin_notice')) {
    /**
     ...
     */
    function ads_manager_skip_php_admin_notice() {
...
add_action('admin_notices', 'ads_manager_skip_php_admin_notice');
